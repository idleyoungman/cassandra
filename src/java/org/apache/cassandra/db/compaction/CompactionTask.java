...
public class CompactionTask extends AbstractCompactionTask
{
    ...
    private final boolean ignoreOverlapCheck;
    protected static long totalBytesCompacted = 0;
    private CompactionExecutorStatsCollector collector;

    public CompactionTask(ColumnFamilyStore cfs, LifecycleTransaction txn, int gcBefore, boolean offline)
    {
        this(cfs, txn, gcBefore, offline, false);
    }

    public CompactionTask(ColumnFamilyStore cfs, LifecycleTransaction txn, int gcBefore, boolean offline, boolean ignoreOverlapCheck)
    {
        super(cfs, txn);
